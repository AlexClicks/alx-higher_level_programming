...
OBOBOB        """ Trying to pass invalid values """
    ...
    def test_value_attrs_3(self):
        """ Trying to pass invalid values """
OBOBOB        with self.assertRaises(ValueError):
...
OBOBOB    def test_area_2(self):
    ...
    def test_display(self):
        """ Test string printed """
OBOBOB        r1 = Rectangle(2, 5)
OBOBOB        res = "##\n##\n##\n##\n##\n"
OBOBOB        with patch('sys.stdout', new=StringIO()) as str_out:
            r1.display()
...
OBOBOB        res = "[Rectangle] (1) 2/4 - 2/5\n"
        with patch('sys.stdout', new=StringIO()) as str_out:
            print(r1)
OBOBOB            self.assertEqual(str_out.getvalue(), res)
OBOBOB
OBOBOB    def test_str_2(self):
        """ Test __str__ return value """
...
OBOBOBOBOBOB        r1.id = 1
OBOBOB        r1.width = 7
OBOBOB        r1.height = 15
...
OBOBOBOBOBOB        r2 = Rectangle(25, 86, 4, 7)
OBOBOB        res = "[Rectangle] (2) 4/7 - 25/86\n"
        with patch('sys.stdout', new=StringIO()) as str_out:
            print(r2)
            self.assertEqual(str_out.getvalue(), res)
    ...
    def test_str_4(self):
        """ Test __str__ return value """
        r1 = Rectangle(3, 3)
OBOBOB        res = "[Rectangle] (1) 0/0 - 3/3"
OBOBOB        self.assertEqual(r1.__str__(), res)

OBOBOB    def test_display_3(self):
        """ Test string printed """
...
OBOBOB        self.assertEqual(r1.x, 3)
        self.assertEqual(r1.y, 4)
OBOBOB        self.assertEqual(r1.id, 1)
